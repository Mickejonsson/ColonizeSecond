...
namespace Colonize.Website.Data
{
    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var destinations = new List<Destinaton>
            {
                new Destinaton(1, "Moon", "Lorem ipsum dolor" ,
                new Uri("https://via.placeholder.com/480x360.png?text=Moon", UriKind.Absolute)),

                new Destinaton(2, "Mars","Lorem ipsum dolor",
                new Uri("https://via.placeholder.com/480x360.png?text=Mars", UriKind.Absolute)),
            };


            destinations.ForEach(x => modelBuilder.Entity<Destinaton>().HasData(x));
